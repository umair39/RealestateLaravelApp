        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10">
                    ...
                    <p class="mb-5"><strong class="h2 text-success font-weight-bold">Rs{{ $singleProp->price }}</strong></p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="bg-white property-body border-bottom border-left border-right">
                        <div class="row mb-5">
                            <div class="col-md-6">
                                <strong class="text-success h1 mb-3">Rs{{ $singleProp->price }}</strong>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                                ...
                                <strong class="d-block">Rs{{ $singleProp->price_sqft }}</strong>
                            </div>
                        </div>
