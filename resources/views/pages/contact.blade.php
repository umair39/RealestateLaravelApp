            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="p-4 mb-3 bg-white">
                        ...
                        <p class="mb-4">203 Jinnah colony Faisalabad</p>

                        <p class="mb-0 font-weight-bold">Phone</p>
                        <p class="mb-4"><a href="#">+923049892083</a></p>

                        <p class="mb-0 font-weight-bold">Email Address</p>
                        <p class="mb-0"><a href="#">chumairtalib3232@gmail.com</a></p>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        ...
                        <img src="{{asset('assets/images/umair2.jpg')}}" alt="Image" class="img-fluid rounded mb-4">

                        <div class="text">

                            <h2 class="mb-2 font-weight-light text-black h4">Muhammad Umair</h2>
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        ...
                        <img src="{{asset('assets/images/umair3.jpg')}}" alt="Image" class="img-fluid rounded mb-4">
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        ...
                        <img src="{{asset('assets/images/umair4.jpg')}}" alt="Image" class="img-fluid rounded mb-4">
