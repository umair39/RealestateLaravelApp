                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center text-center">
                        <div class="col-md-10">
                            ...
                            <p class="mb-5"><strong class="h2 text-success font-weight-bold">Rs
                                    {{ $prop->price }}</strong>
                            </p>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="select-wrap">
                                ...
                                <select name="home_type" id="list-types" class="form-control d-block rounded-0">
                                    ...
                                    <option value="Commercial Building">House</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="select-wrap">
                                ...
                                <select name="city" id="select-city" class="form-control d-block rounded-0">
                                    <option value="New York">fsd</option>
                                    <option value="Brooklyn">lahore</option>
                                    <option value="London">islamabad</option>
                                    <option value="Japan">karachi</option>
                                    <option value="Philippines">hafizabad</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-100">
                            ...
                            <div class="p-4 property-body">
                                ...
                                <strong
                                    class="property-price text-primary mb-3 d-block text-success">Rs{{ $prop->price }}</strong>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        <img src="{{ asset('assets/images/umair3.jpg') }}" alt="Image"
                            class="img-fluid rounded mb-4">
                        <div class="text">
                            <h2 class="mb-2 font-weight-light text-black h4">Raza</h2>
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        <img src="{{ asset('assets/images/umair2.jpg') }}" alt="Image"
                            class="img-fluid rounded mb-4">
                        <div class="text">
                            <h2 class="mb-2 font-weight-light text-black h4">Ali</h2>
                            <span class="d-block mb-3 text-white-opacity-05">Real Estate Agent</span>
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        <img src="{{ asset('assets/images/umair4.jpg') }}" alt="Image"
                            class="img-fluid rounded mb-4">
                        <div class="text">
                            <h2 class="mb-2 font-weight-light text-black h4">M_umair</h2>
                            <span class="d-block mb-3 text-white-opacity-05">Real Estate Agents</span>
